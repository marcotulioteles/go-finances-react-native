...
export function Dashboard() {
  ...
  return (
    <Container>
      ...
      {isLoading ? <LoadContainer><ActivityIndicator color={theme.colors.secondary} size='large' /></LoadContainer> :
        <>
          <Header>
            <UserWrapper>
              <UserInfo>
          ...
          <HighlightCards>
            ...
            <HighlightCard
              ...
              lastTransaction={(highlightData.expenses.lastTransaction === '0') ? 
                'Não há transações' : 
                `Última saída ${highlightData.expenses.lastTransaction}`}
            />
            <HighlightCard
              type="total"
              title="Total"
